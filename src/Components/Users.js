                        ...
                        {usersalldata ? usersalldata.map((data) => {
                            return (
                                <tr className='mt-2' id={data.id + "__path"}>
                                    ...
                                    <td>{data.username}</td>
                                    <td>{data.email}</td>
                                    <button className='btn btn-outline-danger mt-2 btn-sm' value={data.id} onClick={(e) => deleteUserCall(e)}>DELETE</button>
                                    <button className='btn btn-warning mt-3 mb-2 btn-sm mx-2' value={data.id} onClick={(e) => editUserCall(e)}>EDIT</button>
                                </tr>
                            )
                        }) : (<></>)}
                    </tbody>
